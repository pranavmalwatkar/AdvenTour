...
<body>
  ...
  <form action="../../../../Database/bookdetails.php" method="POST">
    ...
    <div id="body">
      <img src="../../../../Images/pune5.jpg" class="stretch" alt="" />
    </div>
    <div class="text">
      <input type="hidden" name="destination" value="ISKCON NVCC">
      ISKCON NVCC
    </div>

    <div class="box" style="font-family: 'Alata'; font-size: 22px; color: #ff571b; text-decoration: none">

      <b style="font-size: 50; font-family: fantasy"></b>Tour destination : ISKCON NVCC
      <hr style="border: 2px solid darkgrey" />


      <p style="color:black"><b>ISKCON NVCC</b> a 13 storey palace of Peshwas was built by Bajirao-I,
    ...
    <div class="box2" style="font-family: 'Alata'; font-size: 22px; color: #ff571b; text-decoration: none">
      ...
      <hr style="border: 2px solid darkgrey" />
      <br>
      <b style="color:black;font-size:110%">ISKCON NVCC, Pune :</b>
      ...
      <input type="hidden" name="redirectTo" value="Homepage/Pune/Destinations/ISKCON NVCC/ISKCON NVCC.php" />
  </form>

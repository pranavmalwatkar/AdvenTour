...
<body>
  ...
  <form action="../../../../Database/bookdetails.php" method="POST">
    ...
    <div id="body">
      <img src="../../../../Images/mumbai2.jpg" class="stretch" alt="" />
    </div>
    <div class="text">
      <input type="hidden" name="destination" value="Tajhotel">
      Taj Hotel
    </div>

    <div class="box" style="font-family: 'Alata'; font-size: 22px; color: #ff571b; text-decoration: none">

      <b style="font-size: 50; font-family: fantasy"></b>Tour destination : Taj Hotel
      <hr style="border: 2px solid darkgrey" />


      <p style="color:black"><b>Taj Hotel</b> a 13 storey palace of Peshwas was built by Bajirao-I,
    ...
    <div class="box2" style="font-family: 'Alata'; font-size: 22px; color: #ff571b; text-decoration: none">
      ...
      <hr style="border: 2px solid darkgrey" />
      <br>
      <b style="color:black;font-size:110%">Taj Hotel, Pune :</b>
